...
namespace ADOForm
{
    public partial class Moviefix : Form
    {
        ...
        private void showDataGridView() //사용자 정의 함수
        {
            try
            {
                ...
                oda.SelectCommand = new OracleCommand("SELECT * from movie", odpConn);
        ...
        private void Moviefix_Load(object sender, EventArgs e)
        {
        ...
        private void 선택한행업데이트ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Moviefixcon form2 = new Moviefixcon(this);
            form2.ShowDialog();
            form2.Dispose();
            showDataGridView();
        }
